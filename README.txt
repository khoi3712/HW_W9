...
# (which will be used for auto-feedback) match the answers in your PDF writeup.
#
...
# Be sure to use a plain text editor when editing this file (e.g., not Notepad, etc.).
...
LINREGIMPLEMENTATION_CLOSEDFORM: thetaClosedForm = 0
